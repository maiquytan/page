...
export const dataApplication = [
  ...
  { title: 'Alexis CRM', content: 'Website', img: '/illustration2.webp', category: 'Enterprise management systems' },
  { title: 'Sekisho', content: 'Website', img: '/illustration3.webp', category: 'ECommerce & Retail Software development' },
  { title: 'Nistone-Loan', content: 'Phone Application', img: '/illustration4.webp', category: 'New business ideas' },
  { title: 'ASP', content: 'Website', img: '/illustration5.webp', category: 'Customer-enabling services' },
  { title: 'Loycus', content: 'Website', img: '/illustration6.webp', category: 'Others' },
  { title: 'BH', content: 'Website', img: '/illustration7.webp', category: 'Customer-enabling services' },
]
...
export const listInforCompanyJP = [
  { title: '会社名', content: '株式会社アクサライズ / AXALIZE INCORPORATED' },
  { title: '所在地', content: 'Level 2, 25T2, Lot N05, Tran Duy Hung,Trung Hoa, Cau Giay, Ha Noi, VIETNAM' },
  { title: '代　表', content: '中尾 健悟（Nakao Kengo）' },
  { title: '設　立', content: '2019年4月13日' },
  { title: '資本金', content: '約500万円' },
  { title: '従業員数', content: '20名 （2022年8月時点）' },
  { title: '事業内容', content: 'オフショアソフトウェア開発、WEB・モバイルアプリ開発' },
]
